 ...
 *
 * Stored in SharedPreferences, which lives in the app's private data directory.
 * It survives app restarts and updates, but is wiped if you uninstall the app,
 * so it's worth exporting once the list gets long.
 */
